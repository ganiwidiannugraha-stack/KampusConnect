  ...
  return (
    ...
    >
      ...
      <button 
        type="submit"
        disabled={pending}
        className="w-full h-11 mt-4 inline-flex items-center justify-center rounded-xl bg-primary text-primary-foreground font-bold hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {pending ? 'Memproses...' : 'Masuk'}
      </button>

      <div className="mt-4 text-center text-sm text-muted-foreground">
        Gunakan <strong>admin@kampus.com</strong> / <strong>password123</strong> untuk Admin.<br />
        Gunakan <strong>ukm@kampus.com</strong> / <strong>password123</strong> untuk Mahasiswa.
      </div>
    </form>
  );
}
